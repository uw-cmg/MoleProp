...
#SBATCH --error=/srv/home/nkrakauer/moleprop/paper_comparison/patel10/test/tst-%j.err
#SBATCH --output=/srv/home/nkrakauer/moleprop/paper_comparison/patel10/test/tst-%j.out
...
python -u /srv/home/nkrakauer/moleprop/paper_comparison/patel10/test/test.py > buffer.txt

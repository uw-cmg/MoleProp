...
#SBATCH --error=/srv/home/nkrakauer/moleprop/paper_comparison/chen14/test/tst-%j.err
#SBATCH --output=/srv/home/nkrakauer/moleprop/paper_comparison/chen14/test/tst-%j.out
...
python -u /srv/home/nkrakauer/moleprop/paper_comparison/chen14/test/test.py > buffer.txt

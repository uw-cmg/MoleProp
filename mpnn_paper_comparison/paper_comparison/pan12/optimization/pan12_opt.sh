...
#SBATCH --error=/srv/home/nkrakauer/moleprop/paper_comparison/pan12/optimization/opt-%j.err
#SBATCH --output=/srv/home/nkrakauer/moleprop/paper_comparison/pan12/optimization/opt-%j.out
...
python -u /srv/home/nkrakauer/moleprop/paper_comparison/pan12/optimization/opt.py > buffer.txt

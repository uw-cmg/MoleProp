...
#SBATCH --error=/srv/home/nkrakauer/moleprop/paper_comparison/carroll15/test/tst-%j.err
#SBATCH --output=/srv/home/nkrakauer/moleprop/paper_comparison/carroll15/test/tst-%j.out
...
python -u /srv/home/nkrakauer/moleprop/paper_comparison/carroll15/test/test.py > run0Buffer.txt

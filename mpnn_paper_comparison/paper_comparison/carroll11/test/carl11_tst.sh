...
#SBATCH --error=/srv/home/nkrakauer/moleprop/paper_comparison/carroll11/test/tst-%j.err
#SBATCH --output=/srv/home/nkrakauer/moleprop/paper_comparison/carroll11/test/tst-%j.out
...
python -u /srv/home/nkrakauer/moleprop/paper_comparison/carroll11/test/test.py > run2Buffer.txt

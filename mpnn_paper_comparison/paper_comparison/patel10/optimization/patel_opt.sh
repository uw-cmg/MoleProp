...
#SBATCH --error=/srv/home/nkrakauer/moleprop/paper_comparison/patel10/optimization/opt-%j.err
#SBATCH --output=/srv/home/nkrakauer/moleprop/paper_comparison/patel10/optimization/opt-%j.out
...
python -u /srv/home/nkrakauer/moleprop/paper_comparison/patel10/optimization/opt.py > buffer.txt

...
#SBATCH --error=/srv/home/nkrakauer/moleprop/paper_comparison/pan12/test/tst-%j.err
#SBATCH --output=/srv/home/nkrakauer/moleprop/paper_comparison/pan12/test/tst-%j.out
...
python -u /srv/home/nkrakauer/moleprop/paper_comparison/pan12/test/test.py > buffer.txt
